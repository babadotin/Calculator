...
final themeProvider = StateNotifierProvider<ThemeNotifier, ThemeEnum>(
  (ref) {
...
class ThemeNotifier extends StateNotifier<ThemeEnum> {
  ...
  static ThemeEnum _loadThemeFromCache() {
    int themeIndex = CacheData.getData(
          key: 'theme',
        ) ??
        0;
    return ThemeEnum.values.elementAt(
      themeIndex.clamp(0, ThemeEnum.values.length - 1),
    );
  }
